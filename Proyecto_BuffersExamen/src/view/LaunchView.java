...
public class LaunchView extends JFrame {
	...
	private JButton btnBuscarTodasPalabras;
	private JButton btnBuscarEmpiezaPalabra;
	private JButton btnContadorDePalabras;
	...
	public LaunchView() {
		...
		panel.add(btnEj1);
				...
				btnContadorDePalabras = new JButton("Contador de palabras");
				panel.add(btnContadorDePalabras);
				
				btnBuscarEmpiezaPalabra = new JButton("Buscar empieza palabra");
				panel.add(btnBuscarEmpiezaPalabra);
				
				btnBuscarTodasPalabras = new JButton("Buscar todas Palabras");
				panel.add(btnBuscarTodasPalabras);
	...
	public JButton getBtnContadorDePalabras() {
		return btnContadorDePalabras;
	}

	public void setBtnContadorDePalabras(JButton btnContadorDePalabras) {
		this.btnContadorDePalabras = btnContadorDePalabras;
	}

	public JButton getBtnBuscarEmpiezaPalabra() {
		return btnBuscarEmpiezaPalabra;
	}

	public void setBtnBuscarEmpiezaPalabra(JButton btnBuscarEmpiezaPalabra) {
		this.btnBuscarEmpiezaPalabra = btnBuscarEmpiezaPalabra;
	}

	public JButton getBtnBuscarTodasPalabras() {
		return btnBuscarTodasPalabras;
	}

	public void setBtnBuscarTodasPalabras(JButton btnBuscarTodasPalabras) {
		this.btnBuscarTodasPalabras = btnBuscarTodasPalabras;
	}
