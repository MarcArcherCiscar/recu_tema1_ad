...
public class GestionEventos {
	...
	private ActionListener actionListener_comparar, actionListener_buscar,actionListener_LibrosInterfaz,actionListener_enviar, actionListener_buscarTodasPalabras, actionListener_buscarPorDondeEmpieza, actionListener_contadorDePalabras;
	...
	public void contol() {
		...
		actionListener_contadorDePalabras=new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {

				try {
					call_contadorPalabras();
		...
		view.getBtnContadorDePalabras().addActionListener(actionListener_contadorDePalabras);
		
		actionListener_buscarPorDondeEmpieza=new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				try {
					call_buscarPorDondeEmpieza();
		...
		view.getBtnBuscarEmpiezaPalabra().addActionListener(actionListener_buscarPorDondeEmpieza);
		
		actionListener_buscarTodasPalabras=new ActionListener() {
		...
		view.getBtnBuscarTodasPalabras().addActionListener(actionListener_buscarTodasPalabras);
	...
	private void call_todasPalabras() throws IOException {
		// TODO Auto-generated method stub
view.getTextArea().setText(model.todasPalabras(view.getFichero1().getText()));
	}
	

	private void call_buscarPorDondeEmpieza() throws IOException {
		// TODO Auto-generated method stub
		model.BuscarPorEmpieza(view.getFichero1().getText(), view.getPalabra().getText());
	}
	

	private void call_contadorPalabras() throws IOException {
		// TODO Auto-generated method stub
		model.ContadorDePalabras(view.getFichero1().getText(), view.getPalabra().getText());
	}
